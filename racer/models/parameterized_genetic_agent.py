...
parameterized_genetic = Ingredient("parameterized_genetic", ingredients=[car_racing_env, genetic])
...
class ParameterizedGeneticAgent(GeneticAgent):
    ...
    def __init__(self, individual_fname):
        parameterized_policy = ParameterizedIndividual.from_pickled_individual(individual_fname)
        super(ParameterizedGeneticAgent, self).__init__(policy_function=parameterized_policy)
